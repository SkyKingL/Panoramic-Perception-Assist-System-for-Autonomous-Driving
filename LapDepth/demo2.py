...
parser.add_argument('--img_dir', type=str, default="example/I-80_Eastshore_Fwy.jpg")  # 要预测的图片
...
if args.img_dir is not None:
    ...
    result_filelist = ['./Out/out_' + args.img_dir.split('/')[-1]]  # 输出图片，名字叫out_图片名
...
for i, img_file in enumerate(img_list):  # i 是数据下标， img_file 是数据
    cap = cv2.VideoCapture("data/video/00.mp4")
    # #获取一帧图像的宽
